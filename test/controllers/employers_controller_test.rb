...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { activitysector: @employer.activitysector, city: @employer.city, country: @employer.country, description: @employer.description, name: @employer.name }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { activitysector: @employer.activitysector, city: @employer.city, country: @employer.country, description: @employer.description, name: @employer.name }
    assert_redirected_to employer_path(assigns(:employer))
  end
